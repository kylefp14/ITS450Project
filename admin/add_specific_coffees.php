...
// Number of possible specific paints to add at once:
$count = 10;
...
?><h3>Add Specific Paints</h3>

<form action="add_specific_coffees.php" method="post" accept-charset="utf-8">

	<fieldset><legend>Fill out the form to add specific paint products to the site.</legend>
		
		<div class="field"><label for="category"><strong>General Paint Type</strong></label><br />
